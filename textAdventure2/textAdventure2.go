...
func main() {
	...
	The eastern passage appears flat and well traveled.
	`}
	...
	The dark passage is now lit by your lantern. You can continue north or head back south.
	`}
	...
	You arrive at a small chamber...that is filled with treasure!
	`}
